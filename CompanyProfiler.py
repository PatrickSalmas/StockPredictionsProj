...
class Profiler:
    def __init__(self,company,dayPred,investment,pctIncrease,pctDecrease):
        self.CoName = company
        self.money_in = 0
        ...
        self.liquidVal = 0
        profilePath = "C:/Users/psalm/Documents/StockProj/S&P500_Profiles/"+str(dayPred)+"DayPred/"+str(investment)+"/"+str(pctIncrease)+"_"+str(pctDecrease)
